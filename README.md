# Visual Sequencer <a href="https://github.com/GianlucaColia/Visual-Sequencer/releases/download/v1.6.0/Visual.Sequencer.v-1.6.0.zip"><img src="" alt="Download" style="vertical-align: middle; margin-left: 10px;"></a>
